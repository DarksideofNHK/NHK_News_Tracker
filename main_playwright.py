#!/usr/bin/env python3
"""
NHK RSS差分追跡システム - Playwright版メインスクリプト
"""
import yaml
import logging
...
from scraper_playwright import NhkRssScraperPlaywright
...
def main():
    """メイン実行"""
    print("="*60)
    print("NHK RSS差分追跡システム - Playwright版")
    print("="*60)
    ...
    # 初期化
    scraper = NhkRssScraperPlaywright(headless=True, timeout=30000)
    parser = NhkXmlParser()
