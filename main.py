...
from scraper import NhkRssScraper
...
def main():
    """メイン実行"""
    print("="*60)
    print("NHK RSS差分追跡システム - Python PoC")
    print("="*60)
    ...
    # 初期化
    scraper = NhkRssScraper(timeout=config['scraper']['timeout'])
    parser = NhkXmlParser()
